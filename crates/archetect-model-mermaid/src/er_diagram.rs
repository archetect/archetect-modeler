...
use nom::IResult;
use crate::er_diagram::Cardinality::{ExactlyOne, OneOrMore, ZeroOrMore, ZeroOrOne};
use crate::er_diagram::Identification::{Identifying, NonIdentifying};

#[derive(Clone, Debug, PartialOrd, PartialEq)]
pub struct MermaidErDiagram<'i> {
    pub sections: Vec<DiagramSection<'i>>,
}

pub fn mermaid_er_diagram(input: &str) -> IResult<&str, MermaidErDiagram> {
...
#[derive(Clone, Debug, PartialOrd, PartialEq)]
pub struct Entity<'i>(&'i str);

#[derive(Clone, Debug, PartialOrd, PartialEq)]
pub struct Label<'i>(&'i str);

#[derive(Clone, Debug, PartialOrd, PartialEq)]
pub struct EntityRelation<'i> {
    pub left: Entity<'i>,
    pub right: Entity<'i>,
    pub label: Label<'i>,
